...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('search-form').addEventListener('submit', function (e) {
        ...
        var searchString = document.getElementsByName('search-field');

        fetch('https://www.googleapis.com/books/v1/volumes?q=' + searchString[0].value, { method: 'get' }).then(function (response) {
            ...
            books.items.map(function (elem) {

                var newResultElem = document.createElement('div');
    ...
    document.body.onclick = function (e) {
        ...
        if (target.className == 'close' && target.closest('.buy-pop-up') || target.className == 'buy-pop-up') {
            removePopUp();
        }
    };
    // ------------------------- END Close Pop Up ---------------------
    ...
    document.onclick = function (e) {
        ...
        if (target.closest('.buy-pop-up') && target.className == 'send') {
            var inputsCollection = document.getElementsByClassName('buy-pop-up')[0].getElementsByTagName('input');
